...
contract Config is Constants, Script {
    ...
    constructor() {
        ...
        networkConfigs[ETH_MAINNET_CHAIN_ID] = _getMainnetEthConfig();
    }
    ...
    function getConfig() external returns (NetworkConfig memory) {
        ...
        if (networkConfigs[chainId].vrfCoordinatorV2_5 != address(0)) {
            ...
            revert Config__UnknownChainId();
        }
    }

    function _getMainnetEthConfig() private pure returns (NetworkConfig memory mainnetNetworkConfig) {
